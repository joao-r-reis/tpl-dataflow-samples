...
namespace SieveOfEratosthenesTests
{
    ...
    [TestClass]
    public class ParallelSieveOfEratosthenesStrategyTests
    {
        private readonly ParallelSieveOfEratosthenesStrategy target;

        public ParallelSieveOfEratosthenesStrategyTests()
        {
            this.target = new ParallelSieveOfEratosthenesStrategy();
        }
