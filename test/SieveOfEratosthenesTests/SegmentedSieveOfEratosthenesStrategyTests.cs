...
namespace SieveOfEratosthenesTests
{
    ...
    [TestClass]
    public class SegmentedSieveOfEratosthenesStrategyTests
    {
        private readonly SegmentedSieveOfEratosthenesStrategy target;

        public SegmentedSieveOfEratosthenesStrategyTests()
        {
            this.target = new SegmentedSieveOfEratosthenesStrategy();
        }
